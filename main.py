...
from data.data_handler import initialize_db, close_db
...
async def main():
	...
	bot = Bot(intents = intents, owner_id = environ.get("OWNER_ID"))
	await initialize_db()	
	...
	async def on_ready():
		...
		await bot.change_presence(activity = Game(environ.get("ACTIVITY") or " with someone's heart."))
